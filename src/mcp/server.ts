...
export function buildMcpServer(service: JavaService, config: Config, logger: Logger, debug?: DebugService): McpServer {
  ...
  register("java_update_projects", (i, signal) => service.updateProjects(i, signal));
